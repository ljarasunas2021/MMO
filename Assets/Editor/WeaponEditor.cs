...
public class WeaponEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            // Weapon type
            weapon.rangedType = (RangedWeaponType)EditorGUILayout.EnumPopup("Weapon Ranged Type", weapon.rangedType);
        }
        ...
        if (showGrab)
        {
            if (weapon.type == WeaponType.Ranged)
            {
                weapon.rangedHold = (RangedHoldType)EditorGUILayout.EnumPopup("Ranged Weapon Hold Style", weapon.rangedHold);
            }
        ...
        if (weapon.type == WeaponType.Ranged)
        {
            ...
            if (showGeneral)
            {
                ...
                // Projectile
                if (weapon.rangedType == RangedWeaponType.Projectile)
                {
            ...
            // Warmup
            if ((weapon.rangedType == RangedWeaponType.Raycast || weapon.rangedType == RangedWeaponType.Projectile) && weapon.auto == Auto.Semi)
            {
            ...
            // Recoil
            if (weapon.rangedType == RangedWeaponType.Raycast || weapon.rangedType == RangedWeaponType.Projectile)
            {
