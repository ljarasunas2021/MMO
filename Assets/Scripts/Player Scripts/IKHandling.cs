...
{
    public float ikWeight = 1, ikRotWeight, ikRotAnglePower, ikRotPower, raycastDistance = 1, offsetY, lookIKWeight, bodyWeight, headWeight, eyesWeight, clampWeight, lookDistance;
    ...
    void Update()
    {
        ...
        lookPos = ray.GetPoint(lookDistance);
