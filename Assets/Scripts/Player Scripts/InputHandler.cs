...
public class InputHandler : NetworkBehaviour
{
    ...
    {
        if (itemHolding.type != ItemType.none && itemHolding.type != ItemType.collectable && UIManager.instance.canShoot) itemHolding.weaponScript.CheckForUserInput();
        
        //if (itemHolding.type == ItemType.collectable && Input.GetMouseButtonDown(0)) itemHolding.item.gameObject.GetComponent<Collectable>().Use();
    }
