...
public partial class SimpleFootIK_AF
{
    void ShootIKRays()
    {
        ...
        {
            if (raycastHitRightFoot.point.y < raycastHitToe.point.y - footForward.y) raycastHitRightFoot.point = new Vector3(raycastHitRightFoot.point.x, raycastHitToe.point.y - footForward.y, raycastHitRightFoot.point.z);
        ...
        {
            if (raycastHitLeftFoot.point.y < raycastHitToe.point.y - footForward.y) raycastHitLeftFoot.point = new Vector3(raycastHitLeftFoot.point.x, raycastHitToe.point.y - footForward.y, raycastHitLeftFoot.point.z);
        ...
        cc.Move(Vector3.up * Mathf.Lerp(0, Mathf.Min(raycastHitLeftFoot.point.y, raycastHitRightFoot.point.y), transformYLerp * extraYLerp * deltaTime));

        //transform.Translate(Vector3.up * Mathf.Lerp(0, Mathf.Min(raycastHitLeftFoot.point.y, raycastHitRightFoot.point.y) - transform.position.y, transformYLerp * extraYLerp * deltaTime));
    }
}
