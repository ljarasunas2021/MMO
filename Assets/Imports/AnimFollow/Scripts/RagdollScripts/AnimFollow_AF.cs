...
namespace AnimFollow
{
    public class AnimFollow_AF : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("Gravity")] private float gravity = 9.81f;
        ...
        [Range(0f, .64f)] [Tooltip("Torque strength for all limbs")] public float PTorque = .16f; // For all limbs Torque strength
        ...
        public void DoAnimFollow()
        {
            ...
            for (int i = 0; i < slaveRigidTransforms.Length; i++) // Do for all rigid bodies
            {
                ...
                //Debug.Log(ragdollControl.jumping);
                ...
                if (force) // Calculate and apply world force
                {
                    ...
                    if (ragdollControl.jumping) forceSignal.y = 0;
